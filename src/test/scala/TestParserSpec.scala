 ...
 */
class ChelonaParserSpec extends FlatSpec {
  ...
  "The input file ./TurtleTests/turtle-eval-bad-02.ttl" must "fail" taggedAs (TurtleEvalBad) in {
  ...
  "The input file ./TurtleTests/turtle-eval-bad-03.ttl" must "fail" taggedAs (TurtleEvalBad) in {
  ...
  "The input file ./TurtleTests/turtle-eval-bad-04.ttl" must "fail" taggedAs (TurtleEvalBad) in {
  ...
  "The input file ./TurtleTests/IRI_subject.ttl" must "succeed" taggedAs (TurtleAtomic) in {
  ...
  "The input file ./TurtleTests/two_LITERAL_LONG2s.ttl" must "succeed" taggedAs (DaveBeckett) in {
