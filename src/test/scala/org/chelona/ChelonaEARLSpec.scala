...
class ChelonaEARLSpec extends FlatSpec with RDFTripleOutput {
  ...
  "The input file ./TurtleTests/turtle-syntax-string-08.ttl" must "succeed" taggedAs (TurtleSyntax) in {
    ...
    val nt = scala.io.Source.fromFile("./TurtleTests/turtle-syntax-string-08_isomorphic.nt").mkString
  ...
  "The input file ./TurtleTests/turtle-syntax-string-09.ttl" must "succeed" taggedAs (TurtleSyntax) in {
    ...
    val nt = scala.io.Source.fromFile("./TurtleTests/turtle-syntax-string-09_isomorphic.nt").mkString
  ...
  "The input file ./TurtleTests/turtle-syntax-string-10.ttl" must "succeed" taggedAs (TurtleSyntax) in {
    ...
    val nt = scala.io.Source.fromFile("./TurtleTests/turtle-syntax-string-10_isomorphic.nt").mkString
  ...
  "The input file ./TurtleTests/turtle-syntax-string-11.ttl" must "succeed" taggedAs (TurtleSyntax) in {
    ...
    val nt = scala.io.Source.fromFile("./TurtleTests/turtle-syntax-string-11_isomorphic.nt").mkString
